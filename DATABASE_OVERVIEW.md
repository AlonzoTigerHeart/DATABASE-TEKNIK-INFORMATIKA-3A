...
| :--- | :--- | :--- | :--- |
| **Tabel Brand** (Juniar Viki Mahasa) | **`Brand_Id`** (FK di Produk) | 1 Brand memiliki N Produk | Tabel Produk mengambil `Brand_Id` sebagai Kunci Tamu. |
...
| Brand |--------------------------| Product |
+----------------+ +------------------+
| PK Brand_Id | | PK Product_Id |
| Brand_Name | | FK Brand_Id |
